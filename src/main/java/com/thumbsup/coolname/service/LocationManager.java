...
//create location
public Location createlocation(String title, double latitude, double longitude)
{
...
//update location
public int updatelocation(int locationID, String title, double latitude, double longitude)
{
