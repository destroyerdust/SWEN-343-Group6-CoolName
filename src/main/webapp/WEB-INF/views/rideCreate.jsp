...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-8">
				<form class="createRideForm form-horizontal" role="form"
					method="POST">
					...
					<input id="srcLat" name="srcLat" type="hidden" value=""
						class="form-control"> <input id="srcLong" name="srcLong"
						type="hidden" value="" class="form-control"> <input
						id="destLat" name="destLat" type="hidden" value=""
						class="form-control"> <input id="destLong" name="destLong"
					...
					<div class="form-group">
						<label for="departureTime" class="col-sm-2 control-label">Departure
							Time</label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						<label for="arrivalTime" class="col-sm-2 control-label">Arrival
							Time</label>
						<div class="col-sm-8">
							<div class='input-group date' id='datetimepicker2'>
								<input name="arrivalTime" type='text' class="form-control" /> <span
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select id="Group" name="rideGroup" class="form-control">
								<option value="" selected disabled></option> ${userGroups}
							</select>
						</div>
					</div>
					...
					<div class="form-group text-center">
						...
						<div id="WantsRoundtripRide" class="btn-group"
							data-toggle="buttons">
							<label class="btn btn-primary"> <input type="radio"
								value="Yes" name="RoundtripRideChoice">Yes
							</label> <label class="btn btn-primary"> <input type="radio"
								value="No" name="RoundtripRideChoice">No
							</label>
						</div>
					</div>
					...
					<div id="RoundTrip" class="form-group text-center">
						<div class="form-group">
							<label for="returnDepartureTime" class="control-label col-sm-2">
								Return Trip Departure Time </label>
							<div class="col-sm-8">
								<div class='input-group date' id='datetimepicker3'>
									<input name="returnDepartureTime" type='text'
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<div class='input-group date' id='datetimepicker4'>
									<input name="returnArrivalTime" type='text'
										class="form-control" /> <span class="input-group-addon"><span
										class="glyphicon glyphicon-calendar"></span> </span>
								</div>
							</div>
					...
					<c:if test="${isDriver}">
						...
						<div class="form-group text-center">
							...
							<div id="WantsToDrive" class="btn-group" data-toggle="buttons">
								<label class="btn btn-primary"> <input type="radio"
									value="Yes" name="DriveCar">Yes
								</label> <label class="btn btn-primary"> <input type="radio"
									value="No" name="DriveCar">No
								</label>
							</div>
						</div>
									...
									<div class="col-sm-8">
										<select id="Car" name="selectCar" class="form-control">
											<option value="" selected disabled>Select your
												Vehicle</option> ${carChoice}
										</select>
									</div>
								</div>
								<div class="form-group">
									<label for="numSeats" class="control-label col-sm-2">Available
										seats</label>
									<div class="col-sm-8">
										<select id="numSeats" name="numSeats" class="form-control">
											<option value="" selected disabled>Select # of
...
<script>
	...
	(function() {
		...
		var center_lat = 43.0758, center_long = -77.6647;
		...
		function showMarkableMap(center_lat, center_long) {
			...
			google.maps.event.addListener(map, 'click', function(event) {
				var positionClicked = new google.maps.LatLng(
				...
				case 0: //add origin
					...
					document.getElementById('srcLat').value = event.latLng
							.lat();
					document.getElementById('srcLong').value = event.latLng
							.lng();
					break;
				...
				case 1: //add destination
					...
					document.getElementById('destLat').value = event.latLng
							.lat();
					document.getElementById('destLong').value = event.latLng
							.lng();
					break;
